...
const result = await NOOP_TELEMETRY_CONTEXT.startSpan({ name: "example.operation" }, () =>
  runOperation(),
);
```
...
const startAgentSpan = createTypedSpanStarter(telemetryContext, AGENT_TELEMETRY_SCHEMAS);
```

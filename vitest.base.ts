...
export const workspaceSourcePaths = {
  ...
  telemetryTesting: fileURLToPath(
    new URL("./packages/telemetry/src/testing/index.ts", import.meta.url),
  ),
  ...
  serverUnix: fileURLToPath(
    new URL("./packages/server/src/transports/unix/index.ts", import.meta.url),
  ),
...
export default defineConfig({
  resolve: {
    alias: [
      ...
      {
        find: /^@earendil-works\/pi-telemetry\/testing$/,
        replacement: workspaceSourcePaths.telemetryTesting,
      },

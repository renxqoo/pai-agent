...
try {
  ...
  const includedAiSdkPackages = aiSdkPackages.filter((packageName) =>
    includesNodePackage(inputs, packageName),
  );
  if (includedAiSdkPackages.length !== 1 || includedAiSdkPackages[0] !== "@anthropic-ai/sdk") {
    throw new Error(
